    ...
    return (
        <div className="max-w-[1440px] w-full flex flex-col justify-center items-center md:py-12 pb-12 relative">
            <div className="flex items-center justify-center sm:w-[80%] w-full mt-0.5 mx-auto">
                ...
                <span className="px-4 text-center text-wrap" style={{backgroundColor: 'var(--Background)', color: 'var(--Paragraph)', fontSize: 'var(--P1-size)'}}>
            ...
            {/* Logos */}
            <HorizontalMarquee brands={brandsOne} bgColor="var(--Placeholder)" textColor="var(--Heading)" />
            ...
            <div className="flex flex-col md:flex-row gap-4 rounded-4xl p-4 md:p-6 bg-[#E6EBE9] max-w-[1392px] w-full items-stretch">
                ...
                >
                    <Image
                        ...
                        className="rounded-3xl w-full h-full object-cover transition-opacity duration-500"
